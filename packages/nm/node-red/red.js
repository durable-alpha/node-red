...
// Register module aliases before any other requires
...
if (parsedArgs.settings) {
  ...
  if (fs.existsSync(path.join(process.env.NODE_RED_HOME, ".config.json"))) {
    ...
    var userDir =
      parsedArgs.userDir || path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH, ".node-red");
